...
MENU = { main: ['1 - Создавать объекты',
         ...
         for_booking: ['5 - Оформить билет', '5 - Погрузить товар в вагон'] }.freeze
WAGONS = [[],
['   ╔=========╗
   ║ □ □ □ □ ║
  х╚=оо===оо=╝х'],
...
['  ╔=========╗  ╔=========╗  ╔=========╗  ╔=========╗
 ...
 ['  ╔=========╗  ╔=========╗  ╔=========╗  ╔=========╗  ╔=========╗
   ║ □ □ □ □ ║  ║ □ □ □ □ ║  ║ □ □ □ □ ║  ║ □ □ □ □ ║  ║ □ □ □ □ ║
  х╚=оо===оо=╝хх╚=оо===оо=╝хх╚=оо===оо=╝хх╚=оо===оо=╝хх╚=оо===оо=╝х']].freeze
